        ...
        <div class="wrapper_right">
            <fieldset class="right_field field" disabled>
                ...
                <div class="center right_center">
                    ...
                    <label>NOM :</label>
                    <input type="text" class="nom" class="right_nom" name="nom" value="<?=$article[13]?>" readonly><br>

                    <label>PRENOM :</label>
                    <input type="text" class="prenom" class="right_prenom" name="prenom" value="<?=$article[14]?>" readonly><br>

                    <label>DATE DE NAISSANCE :</label>
                    <input type="text" class="date" class="right_date" name="date" value="<?=$article[15]?>" readonly><br>

                    <label>Mail :</label>
                    <input type="email" class="email" class="right_email" name="email" value="<?=$article[16]?>" readonly><br>

                    <label>Réseau social :</label>
                    <input type="text" class="reseau" class="right_reseau" name="reseau" value="<?=$article[17]?>" readonly><br>
                    <br>
                    <label>Présentation :</label>
                    <input type="text" class="engagement" class="right_engagement" name="engagement" value="<?=$article[18]?>" readonly><br>

                    <label>DUREE :</label>
                    <input type="text" class="duree" class="right_duree" name="duree" value="<?=$article[19]?>" readonly><br><br>
                </div>   
