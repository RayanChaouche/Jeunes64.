        ...
        if(!empty($_POST['check_list'])) // on verifie si le jeune a bien validé au moins une checkbox
        {
            ...
            <head>
                ...
                header
                {
                    ...
                    background-image:
                    radial-gradient(
                        circle at left 80vmin top 300px,
                        white 40%,
                        #aaa             
                    );
                    text-align: right;
                ...
                /* dégradé de couleur de la barre de navigation */
                #nav #li_nav1 
                {
                ...
                #nav #li_nav3 
                {
                    background-image: linear-gradient(to right,#E9E9E9,#DDD);   
                }
                #nav #li_nav4 
                {
                    background-image: linear-gradient(to right,#DDD,lightgrey);
                    padding-right: 1%;
                }
                ...
                /*couleur des textes de la navbar*/
                #nav #a_nav1 
                {
                    pointer-events: none; /* rend le lien incliquable*/
                    color: #EC018C;
                }
                #nav #a_nav2 
                {
                ...
                {
                    width: 100%;
                    background: url("images/consultant.PNG") no-repeat 45% 10%, 
                        radial-gradient(
                            ...
                            <div class="dv_check">
                                <fieldset class="field_checkbox" disabled>
                                    ...
                                    <div class="dv_checkbox left_check">
                                        <h3> Je suis*</h3>
                                        <div>
                                            <input type="checkbox" class="check" name="'.$article[9].'" checked readonly>
